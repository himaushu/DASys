...
var dataTypes       = {1:'String', 2:'Numeric'};// {Id:2, Name:'Numeric'}, {Id:3, Name:'Boolean'}, {Id:4, Name:'Date'}];
...
var boolVal         = [{Id:1, Name:'True'}, {Id:2, Name:'false'}]; 
...
var tmp = function(){
var ret = {Id:0, FieldName:'<Field' + cnt + '>', FieldType:1, FieldSize:10, FieldValidations:'', Nullable:'on', IsPrimaryKey:false };
 return ret ;
};
